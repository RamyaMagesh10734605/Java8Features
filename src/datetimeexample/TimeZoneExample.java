...
/*
 * Zone specific data time lib. not the local date time.
 * 
 */
public class TimeZoneExample {
	...
	public static void main(String[] args) {
		...
		ZonedDateTime zd = ZonedDateTime.now(); //2024-03-17T18:14:10.750682200-04:00[America/New_York]
		
		System.out.println(zd);//2024-03-17T18:23:35.593888200-04:00[America/New_York]
		//get
		System.out.println(zd.getDayOfMonth()); //17
		System.out.println(zd.getDayOfYear()); //77
		System.out.println(zd.getHour());//18
		System.out.println(zd.getLong(ChronoField.DAY_OF_MONTH)); //17
		System.out.println(zd.getMinute()); //23
		System.out.println(zd.getMonthValue());//3
		System.out.println(zd.getNano()); //593888200
		System.out.println(zd.getSecond()); //35
		System.out.println(zd.getYear()); //2024
		System.out.println(zd.getChronology()); //ISO
		System.out.println(zd.getDayOfWeek()); //SUNDAY
		System.out.println(zd.getMonth()); //MARCH
		System.out.println(zd.getOffset()); //-04:00
		System.out.println(zd.getZone()); //America/New_York
		
		//of
		System.out.println(ZonedDateTime.of(LocalDateTime.now(), zd.getZone()));
		System.out.println(ZonedDateTime.of(LocalDate.now(), LocalTime.now(), zd.getZone()));
		System.out.println(ZonedDateTime.of(2025, 07, 29, 06, 00, 00, 877770, zd.getZone()));
		System.out.println(ZonedDateTime.ofInstant(Instant.now(), zd.getZone()));
		System.out.println(ZonedDateTime.ofInstant(LocalDateTime.now(), zd.getOffset(), zd.getZone()));
		System.out.println(ZonedDateTime.ofLocal(LocalDateTime.now(), zd.getZone(),zd.getOffset()));
		System.out.println(ZonedDateTime.ofStrict(LocalDateTime.now(), zd.getOffset(), zd.getZone()));
		...
		//EST2024-03-17T18:35:18.312045500-04:00[America/Detroit]
		
		System.out.println("Clock"+ZonedDateTime.now(Clock.system(ZoneId.of("America/Detroit"))));
		//Clock2024-03-17T18:37:43.149953800-04:00[America/Detroit]
		
		LocalDateTime ldt = LocalDateTime.now(ZoneId.of("America/Detroit"));
		System.out.println(ldt);//2024-03-17T18:40:27.392026
		
		 ldt = LocalDateTime.now(Clock.system(ZoneId.of("America/Detroit")));
		System.out.println(ldt);
		//2024-03-17T18:41:14.272759500
		
		System.out.println(LocalDateTime.ofInstant(Instant.now(),ZoneId.systemDefault()));
		//2024-03-17T18:42:43.876710500
		
		//Converting LocalDateTime to ZonedDateTime
        ZonedDateTime dtz= LocalDateTime.now().atZone(ZoneId.of("America/Detroit"));
        System.out.println(dtz);
        
      //Converting Instant to ZonedDateTime
        dtz= Instant.now().atZone(ZoneId.of("America/Detroit"));
        System.out.println(dtz);
        
        //localdatetime to offsetdatetime
        OffsetDateTime odt = LocalDateTime.now().atOffset(ZoneOffset.ofHours(-4));
